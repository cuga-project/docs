...
⚠️ Alert: Don’t read below — to be removed.
...
<Accordions type='single'>
    <Accordion title='🛠️ Technology Stack'>
        - **Python 3.12**: Core runtime environment - **UV**: Modern Python
        package management - **FastAPI**: High-performance web framework -
...
<div align='center'>Made by the CUGA Team at IBM Research</div>
