...
- **Policy system**: Configure agent behavior with Intent Guards, Playbooks, Tool Enrichment, Tool Approval, and Output Formatters to enforce security, guide workflows, and ensure compliance.
