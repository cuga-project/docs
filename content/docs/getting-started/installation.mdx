...
- **[Usage Modes](/docs/customization/modes)**: Learn about different operation modes
- **[Configuration](/docs/customization/overview)**: Customize CUGA for your needs
- **[API Integration](/docs/guides/openapi-integration)**: Integrate CUGA into your applications
