...
See [Control Commands](/docs/customization/cli-sdk) and [Manage, publish, and self-host](/docs/customization/manage-publish).
...
- **Documentation**: Check our [Development](/docs/development/testing) section
...
- **[Configuration](/docs/customization/overview)**: Customize CUGA for your needs
- **[Manage & self-host](/docs/customization/manage-publish)**: Draft, publish, and deploy
- **[Knowledge](/docs/customization/knowledge)**: Ingest documents and cite sources
- **[API Integration](/docs/guides/openapi-integration)**: Connect your OpenAPI and MCP tools
