...
IBM CUGA can operate in browser-only mode, focusing purely on web automation, browser interaction, and web page manipulation without API capabilities.
...
```
"navigate to google.com and search for IBM CUGA"
