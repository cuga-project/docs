...
| Option | Type | Default | Description |
|--------|------|---------|-------------|
| `cuga_mode` | String | `"balanced"` | Code generation profile. Options: `"fast"`, `"balanced"`, `"accurate"`, `"custom"`. Fast is quicker; accurate is slower and more precise. |
...
3. Use `cuga_mode = "fast"` if a quicker code generation profile is enough
