...
The backend is selected via `[secrets].mode` in `settings.toml`. See the full option list in the [Settings reference](/docs/configure/settings-reference#secrets).
