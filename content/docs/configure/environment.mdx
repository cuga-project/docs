...
1. **[Configure overview](/docs/configure/overview)**: Fine-tune CUGA behavior
2. **[Tools](/docs/build/tools)**: Add Python functions, OpenAPI, or MCP
3. **[cuga-eval](https://github.com/cuga-project/cuga-eval)**: Run benchmarks
