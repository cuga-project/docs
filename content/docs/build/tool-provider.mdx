...
<TypeTable
  type={{
    name: {
      description: 'Function name (used as the tool identifier).',
      type: 'str'
    },
    operation_id: {
      description: 'Same as name - the function name serves as the operation identifier.',
      type: 'str'
    },
    arguments: {
    ...
    app_name: {
      description: 'App/service name (if specified in decorator).',
      type: 'Optional[str]'
    },
    duration_ms: {
    ...
    timestamp: {
      description: 'ISO timestamp when the call was made.',
      type: 'str'
    },
    error: {
...
<TypeTable
  type={{
    app_name: {
      description: 'Optional name of the app/service this tool belongs to. Useful for grouping related tools.',
      type: 'Optional[str]',
      default: 'None'
    }
  }}
