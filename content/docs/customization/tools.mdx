...
### Starting the Registry Server (separated from CUGA)
...
The registry supports multiple service types through YAML configuration files. By default, it uses `src/cuga/backend/tools_env/registry/config/mcp_servers.yaml`.
